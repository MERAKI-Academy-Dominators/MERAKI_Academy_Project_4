...
export default function BeforeBloodDonationPage() {
  return (
    <div>
      ...
      <ul>
        Your blood donation experience will be pleasant, safe
        and straightforward if you follow the following tips:
        <li>
          <span>Eat</span> <br />
        ...
        <span>Distract</span> <br />
          ...
          bring a book to read or listen to some music while you donate. We also
          ask donors to undertake something called ‘applied muscle tension’ or
          AMT. This is a simple behavioral technique that helps to maintain
          blood pressure, and so stops you from feeling faint or unwell. It is
          also a brilliant distraction technique! AMT involves tensing and
          relaxing the body’s major muscles during the donation process.
        </li>
        <br />
        <li>
        <span>Know</span> <br />
